...
class FaceBookHelperClient(object):
    ...
    def get_page_info(self):
        url = '{}/{}?fields=name,about,emails,website&access_token={}'.format(self.BASE_URL, self.PAGE_ID, self.ACCESS_TOKEN)
        result = self.make_api_request(url)
        return result

    def update_page_info(self, data):
        encoded_data = urllib.parse.urlencode(data)
        url = '{}/{}?{}&access_token={}'.format(self.BASE_URL, self.PAGE_ID, encoded_data, self.ACCESS_TOKEN)
